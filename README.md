# UI-and-UX
This repo is all abut projects in UI/UX where UI (User Interface) is the look, feel, and interactivity of a digital product (buttons, colors, layout), while UX (User Experience) is the entire journey and feeling a user has with the product, focusing on ease, efficiency, and overall satisfaction.

The Design Process (UX → UI) 
